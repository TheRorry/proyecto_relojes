        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4">
                ...
                <form action="{{ url('admin/productos') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="url_imagen" class="form-label fw-semibold text-dark">Imagen del Reloj</label>
                        <input type="file" name="url_imagen" id="url_imagen" class="form-control @error('url_imagen') is-invalid @enderror">
                        @error('url_imagen')
